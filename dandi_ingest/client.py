...
class DandiClient:
    """Small wrapper around the official DANDI client plus HTTP download workflow."""
    ...
    def _asset_to_record(self, asset: Any, *, dandiset_id: str, version: str) -> AssetRecord:
        ...
        subject_id = self._match_group(_SUBJECT_PATTERN, str(path))
        session_id = self._match_group(_SESSION_PATTERN, str(path))
