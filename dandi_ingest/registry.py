...
from dandi_ingest.datasets import Dataset000336Adapter
from dandi_ingest.datasets import Dataset000458Adapter
from dandi_ingest.datasets import Dataset000718Adapter
from dandi_ingest.datasets import Dataset000871Adapter
from dandi_ingest.datasets import Dataset001710Adapter
...
_ADAPTERS = {
    ...
    "dataset_000458": Dataset000458Adapter(),
