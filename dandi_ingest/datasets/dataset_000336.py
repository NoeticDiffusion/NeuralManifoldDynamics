...
class Dataset000336Adapter:
    adapter_id = "dataset_000336"
    ...
    def build_triage(
        ...
        *,
        ...
        notes = [
            "DANDI 000336 is the canonical Allen Institute OpenScope dendritic-coupling dataset for the lock-side plausibility program.",
            "000336 is the published version of the draft dandiset 000871; only 000336 should be cited or used in analysis.",
